      ...
      <div v-if="item" class="store-item-info">
        ...
        <div class="flex w-full grow bg-[#FFFFFF] p-4 gap-6 flex-wrap">
          <div class="w-full md:w-2/3 rounded overflow-hidden bg-cover">
            <img :src="item.imgUrl" alt="Item Image" class="w-full h-auto rounded" />
          </div>
          <div class="w-full md:w-1/3 flex flex-col gap-4">
            <div v-for="(url, index) in item.additionalImages" :key="index" class="rounded overflow-hidden bg-cover">
              <img :src="url" alt="Additional Image" class="w-full h-40 object-cover rounded" />
            </div>
          </div>
        </div>
        ...
        <div class="flex flex-wrap p-4 gap-6 items-start">
          ...
          <p class="text-3xl font-semibold text-green-600">{{ item.price }}원</p>
        </div>

        <!-- 아이템 상세 정보 -->
        <div class="p-4 grid grid-cols-2 gap-x-8 gap-y-4 border-t border-solid border-t-[#E9DFCE]">
...
export default {
  ...
  name: "캠핑용 모기장",
  price: 50000,
  imgUrl: "https://cdn.pixabay.com/photo/2019/10/03/11/14/camp-4522970_1280.jpg",
  description: "캠핑 시 모기와 벌레로부터 효과적으로 보호해주는 모기장입니다.",
  weight: "1.2kg",
  material: "폴리에스터",
  size: "200 x 150cm",
  capacity: "2인용",
  ...
  reviews: [
    {
      ...
      date: "2024-10-11",
      rating: 5,
      comment: "매우 편리하고 설치가 쉬웠습니다. 야외에서도 정말 유용했어요!"
    },
    {
      username: "John Smith",
      date: "2024-10-01",
  ...
  relatedItems: [
    {
      ...
      name: "다용도 수납 박스",
      price: 30000,
      imgUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRCzh_bqSVwUixWlNdulxIwPSnlIHeQhLoJvw&s"
    },
    {
      id: 3,
      name: "캠핑용 의자",
      price: 45000,
      imgUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSqUSQx7C-UcFc0pfZv-pB5IFn07RtKhvrDAw&s"
    }
  ]
},
{
  ...
  price: 30000,
  imgUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRCzh_bqSVwUixWlNdulxIwPSnlIHeQhLoJvw&s",
  description: "캠핑 장비와 소품을 깔끔하게 정리할 수 있는 다용도 수납 박스입니다.",
  weight: "1.5kg",
  material: "플라스틱",
  size: "60 x 40 x 35cm",
  capacity: "50L",
  ...
  reviews: [
    {
      ...
      date: "2024-09-15",
      rating: 5,
      comment: "수납력이 좋아 캠핑 장비를 정리하는 데 큰 도움이 되었어요!"
    },
    {
      username: "Bob",
      date: "2024-09-10",
      rating: 4,
      comment: "튼튼하고 크기가 적당합니다. 다만 접는 부분이 조금 뻑뻑해요."
    }
  ],
  relatedItems: [
    {
    ...
    },
    {
      ...
      name: "휴대용 가스 버너",
      price: 35000,
      imgUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSh06XCJC2nsNYztwg8Ymx2iszx7EM_HqWpFw&s"
    }
  ]
},
{
  ...
  relatedItems: [
    {
      ...
      name: "캠핑용 테이블",
      price: 55000,
      imgUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQxDPyMIx8mm8wvwgOeTTKnrjuyhjiWzeXiVw&s"
    },
    {
      id: 6,
      name: "아웃도어 랜턴",
      price: 25000,
      imgUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRGAG1M2pHblCAO73P99ED6xmPgd1BxxQ6hwA&s"
    }
  ]
},
{
  ...
  relatedItems: [
    ...
    },
    {
      ...
      name: "침낭 세트",
      price: 80000,
      imgUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQK9ovjbpBs4-fd-cdGjlt-MDEg3fJmS88SHg&s"
    }
  ]
},
{
  ...
  reviews: [
    {
      ...
      date: "2024-07-15",
      rating: 5,
      comment: "튼튼하고 조립이 쉬워서 아주 좋습니다. 캠핑에서 유용하게 썼어요!"
    },
    {
      username: "Hannah",
      date: "2024-07-10",
  ...
  relatedItems: [
    {
      ...
      name: "캠핑용 식기 세트",
      price: 20000,
      imgUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQtuuLDVJPOmp0SG38K5llfKvVCHJf_hVuFWg&s"
    },
    {
      id: 10,
      name: "캠핑용 해먹",
      price: 30000,
      imgUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQRQB7smyQ8HH72QO9wrM0WHE7IsrPx21BEFg&s"
    }
  ]
},
{
  ...
  price: 25000,
  imgUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRGAG1M2pHblCAO73P99ED6xmPgd1BxxQ6hwA&s",
  description: "어두운 야외 환경에서 밝은 조명을 제공하는 아웃도어 랜턴입니다.",
  weight: "0.8kg",
  material: "플라스틱",
  size: "15 x 15 x 25cm",
  capacity: "LED, 200루멘",
  ...
  relatedItems: [
    {
      ...
      name: "휴대용 냉장고",
      price: 150000,
      imgUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT90dUqLeYD3bgvvM2x2cSgWx5H7C_62rbhhQ&s"
    },
    {
      id: 11,
      name: "방수 매트",
      price: 40000,
      imgUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTJZOvBK2rLHS8NZvOGiAV_Czp-UuFFOMIOZQ&s"
    }
  ]
},
{
  ...
  relatedItems: [
    ...
    },
    {
      ...
      name: "캠핑용 주전자",
      price: 15000,
      imgUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTy8tgFry5SxBpiYLcjZkfs3B-4nuUqM_6lNw&s"
    }
  ]
},
{
  ...
  reviews: [
    ...
    },
    {
      ...
      date: "2024-05-28",
      rating: 4,
      comment: "가볍고 사용하기 편리합니다. 다만 포크 크기가 조금 작아요."
    }
  ],
  relatedItems: [
    {
